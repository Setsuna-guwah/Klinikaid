...
export default function Sidebar({ user }: SidebarProps) {
  ...
  const navItemsMap: Record<UserRole, NavItem[]> = {
    admin: [
      ...
      { label: "Reception Queue", href: "/admin/queue", icon: ClipboardList },
      { label: "Dept Records", href: "/admin/records", icon: FileSpreadsheet },
    ...
    receptionist: [
      ...
      { label: "Document Approval", href: "/reception/documents", icon: FileCheck },
      { label: "Triage Routing", href: "/reception/triage", icon: GitPullRequest },
    ],
    department_staff: [
      { label: "My Dept Records", href: "/department/records", icon: FileSpreadsheet },
      { label: "Record Entry", href: "/department/entry", icon: FileText },
      { label: "Documents Queue", href: "/department/documents", icon: ClipboardList },
    ],
    medical_specialist: [
